...
export default function Home() {
  ...
  return (
    <>
      ...
      <div
        id="_payments"
        className={`${quick.className} py-2 h-fit md:grid md:grid-cols-2 container m-auto bg-white mt-10 lg:grid-cols-4`}
      >
        <div className="mb-2 p-2 m-1 before:bg-indigo-500 before:w-[3px] before:rounded-full before:h-[95%] before:bottom-0 before:absolute relative items-center flex">
          <HandThumbUpIcon className="ml-3 h-12 w-auto text-white bg-indigo-500 inline rounded-full p-2" />
          <span className="ml-3"> Limpeza e praticidade</span>
        </div>
        <div className="mb-2 p-2 m-1 before:bg-indigo-500 before:w-[3px] before:rounded-full before:h-[95%] before:bottom-0 before:absolute relative items-center flex">
          <TruckIcon className="ml-3 h-12 w-auto text-white bg-indigo-500 inline rounded-full p-2" />
          <span className="ml-3"> Compre sem sair de casa</span>
        </div>
        <div className="mb-2 p-2 m-1 before:bg-indigo-500 before:w-[3px] before:rounded-full before:h-[95%] before:bottom-0 before:absolute relative items-center flex">
          <CreditCardIcon className="ml-3 h-12 w-auto text-white bg-indigo-500 inline rounded-full p-2 " />
          <span className="ml-3"> Pague com Cartao/Pix</span>
        </div>
        <div className="mb-2 p-2 m-1 before:bg-indigo-500 before:w-[3px] before:rounded-full before:h-[95%] before:bottom-0 before:absolute relative items-center flex">
          ...
          <div className="bg-gray-100 w-full">
            <div className="px-4">
              <div className="mx-auto max-w-2xl py-8   lg:max-w-none">
                <span
                  className={`${quick.className} font-medium tracking-tight text-gray-500 text-2xl`}
                >
      ...
      <div className="container m-auto px-4 block min-h-screen">
        <div className="w-full flex justify-evenly my-10">
          <div className="w-24 bg-[#AF0171] h-20 animate hover:animate-none"></div>
          <div className="w-24 bg-[#F2C2D4] h-20 ml-5"></div>
          <div className="w-24 bg-[#4C0D3B] h-20 ml-5"></div>
          <div className="w-24 bg-[#F4A4C3] h-20 ml-5"></div>
          <div className="w-24 bg-[#D1FFF3] h-20 ml-5 outline-dotted"></div>
          <div className="w-24 bg-[#BEF0CB] h-20 ml-5 outline-dotted"></div>
          <div className="w-24 bg-[#F6F7C1] h-20 ml-5 outline-dotted"></div>
          <div className="w-24 bg-[#0171AF] h-20 ml-5"></div>
        </div>

        <div className="flex w-full justify-evenly">
          <div className="w-24 bg-[#FF0080] h-20"></div>
          <div className="w-24 bg-[#FF00FF] h-20 ml-5"></div>
          <div className="w-24 bg-[#C154C1] h-20 ml-5"></div>
          <div className="w-24 bg-[#FF007F] h-20 ml-5"></div>
          <div className="w-24 bg-[#0171AF] h-20 ml-5"></div>
          {/* that nice  */}
          <div className="w-24 bg-[#0f73ee] h-20 ml-5 outline-dashed"></div>
          <div className="w-24 bg-[#00B9C5] h-20 ml-5 outline-dotted"></div>
          <div className="w-24 bg-[#14B1F0] h-20 ml-5 outline-double"></div>
        </div>
      </div>
    </>
  );
