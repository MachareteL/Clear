  ...
  async function _handleSubmit(event) {
    ...
    if (resposta.user) {
      Swal.fire({
        ...
        text: 'Seja bem-vindo à loja de Produtos Clear!',
        icon: 'success',
      }).then(() => {
        rota.push('/login');
      });
      ...
      Swal.fire({
        ...
        text: 'Essa conta já existe! tente fazer login ou redefinir sua senha!',
        icon: 'info',
      });
    } else {
      Swal.fire({
        title: 'Erro ao criar a sua conta :(',
        text: 'Tente novamente ou entre em contato com um dos nossos desenvolvedores!',
        icon: 'error',
      });
    }
  }
          ...
          <form className="mt-8 space-y-6" onSubmit={_handleSubmit}>
            ...
            <div className="-space-y-px rounded-md shadow-sm">
              <Box>
                <TextField
                  ...
                  variant="outlined"
                  label="E-mail"
                  className="w-full mb-4 appearance-none border-red-500 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                />
                <TextField
                  type="password"
                  ...
                  variant="outlined"
                  label="Senha"
                  className="w-full appearance-none mb-2 text-gray-900 placeholder-gray-500 focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                />
                <TextField
                  type="password"
                  name="password"
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <a
                  href="#"
                  className="font-medium underline underline-offset-2 text-indigo-600 hover:text-indigo-500"
                >
                  Já possuo uma conta
                </a>
              </div>
